...
import nltk
import re
from mydb.db_op import select_all_UA, select_all_response_header
import libs.common
import libs.logger
import libs.db
import config
...
def cosion_kmeans(original_info,ip_list,n_clust):
    cluster = clusters.cosion_kmeans.CosineMeans()
